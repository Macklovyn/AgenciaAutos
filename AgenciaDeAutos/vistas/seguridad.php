...
?>
    ...
    <section>
        ...
        <div class="contenedor">
            <div class="tabla">
                <h3 style="size: 12px;">Sistema Avanzado de Frenado</h3>
                <p>Utiliza tecnología para mejorar la respuesta y precisión del vehículo, aumentando la seguridad y rendimiento al conducir.</p>
                <a href="#" class="boton">Conocer más</a>
            </div>
            <div class="tabla hover">
                <h3>Sistema de Control de Estabilidad</h3>
                <p>Tecnología diseñada para mejorar la estabilidad y el control del vehículo durante maniobras y condiciones de conducción adversas.</p>
                <a href="#" class="boton">Conocer más</a>
            </div>
            <div class="tabla">
                <h3>Airbags Frontales y Laterales</h3>
                <p>Los Airbags Frontales y Laterales son dispositivos de seguridad diseñados para proteger a los pasajeros en caso de colisión.</p>
                <a href="#" class="boton">Conocer más</a>
            </div>
            <div class="tabla">
                <h3>Tecnología de Alerta de Punto Ciego</h3>
                <p>La Tecnología de Alerta de Punto Ciego es un sistema de asistencia a la conducción diseñado para la seguridad en carretera. </p>
                <a href="#" class="boton">Conocer más</a>
            </div>
        </div>
        </section>
