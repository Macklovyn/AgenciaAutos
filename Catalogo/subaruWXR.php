    ...
    <section>
        ...
        <div class="galeria">
            ...
            <div class="contenedor-GaleriaAuto">
                <div class="imagenGA">
                    <img src="../img/WRX1.jpg" alt="" class="gallery-img">
                    <div class="overlay overlay-2">
                        <h5>Pulsa aquí</h5>
                    </div>
                </div>
                <div class="imagenGA">
                    <img src="../img/WRX2.jpg" alt="" class="gallery-img">
                    <div class="overlay overlay-2">
                        <h5>Pulsa aquí</h5>
                    </div>
                </div>
                <div class="imagenGA">
                    <img src="../img/WRX3.jpg" alt="" class="gallery-img">
                    <div class="overlay overlay-2">
                        <h5>Pulsa aquí</h5>
                    </div>
                </div>
                <div class="imagenGA">
                    <img src="../img/WRX4.jpg" alt="" class="gallery-img">
                    <div class="overlay overlay-2">
                        <h5>Pulsa aquí</h5>
                    </div>
                </div>
                <div class="imagenGA">
                    <img src="../img/WRX5.jpg" alt="" class="gallery-img">
                    <div class="overlay overlay-2">
                        <h5>Pulsa aquí</h5>
                    </div>
                </div>
                <div class="imagenGA">
                    <img src="../img/WRX6.jpg" alt="" class="gallery-img">
                    <div class="overlay overlay-2">
                        <h5>Pulsa aquí</h5>
                    </div>
                </div>
