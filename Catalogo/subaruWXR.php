    ...
    <div class="barranav">
        <nav>
            <ul class="nav-links">
                ...
                <li><a href="./desempeñoWXR.php">Desempeño</a></li>
            </ul>
        </nav>
...
<h4 class="section-title">Más imágenes:</h4>
        ...
        <div class="gallery">
          <a href="#img1">
            <img src="../img/WRX1.jpg" alt="Imagen 1">
          </a>
          <a href="#img2">
            <img src="../img/WRX2.jpg" alt="Imagen 2">
          </a>
          <a href="#img3">
            <img src="../img/WRX3.jpg" alt="Imagen 3">
          </a>
        </div>
      ...
      <div class="lightboxes" id="img3">
        ...
        <div class="gallery">
          <a href="#img4">
            <img src="../img/WRX4.jpg" alt="Imagen 4">
          </a>
          <a href="#img5">
            <img src="../img/WRX5.jpg" alt="Imagen 5">
          </a>
          <a href="#img6">
            <img src="../img/WRX6.jpg" alt="Imagen 6">
          </a>
        </div>
      ...
      <div class="lightboxes" id="img6">
        ...
        <div class="gallery">
          <a href="#img7">
            <img src="../img/WRX2.jpg" alt="Imagen 7">
          </a>
          <a href="#img8">
            <img src="../img/WRX1.jpg" alt="Imagen 8">
          </a>
          <a href="#img9">
            <img src="../img/WRX4.jpg" alt="Imagen 9">
          </a>
        </div>
    ...
    <script src="../Catalogo/colorWXR.js"></script>
    <?php 
